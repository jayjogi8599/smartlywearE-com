    ...
    <section className="text-gray-600 body-font bg-sky-100">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap -m-4 justify-center">
          {Object.keys(products).length === 0 && <p>Sorry all the watches are curruntly out of stock. New stock coming soon.stay tuned !</p>}
...
export async function getServerSideProps(context) {
  if (!mongoose.connection[0] && mongoose.connection.readyState) {
   ...
   let watches ={}
    ...
    console.log(watches)
  return {
    props: {products: JSON.parse(JSON.stringify(watches))}, // will be passed to the page component as props
  }
}

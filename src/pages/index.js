...
export default function Home() {
  return (
    <>
      <Head>
        <title>Smartlywear.com</title>
        <meta name="description" content="Being Smart - of wear smart" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className='home'>
      <Image className='homeimg' src='/home5.jpg' alt=''width={750} height={50} />
     </div>
     <section className="text-gray-600 body-font bg-rose-200 ">
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap -m-4">
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-gray-900 p-6 rounded-lg">
          <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-lime-900 mb-4">
    ...
    <button className="flex mx-auto mt-16 text-white bg-slate-600 border-0 py-2 px-8 focus:outline-none hover:bg-lime-900 rounded text-lg">Button</button>
  </div>
</section>    
</>
  )

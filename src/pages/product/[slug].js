...
const Post = ({ buyNow, addToCart, product, variants }) => {
    ...
    return (
        <>
            <section className="text-gray-600 body-font overflow-hidden bg-sky-100">
                <ToastContainer
                    position="bottom-center"
                    autoClose={3000}
                    hideProgressBar={false}
                ...
                <div className="container px-5 py-8 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <h2 className="text-sm title-font text-gray-500 tracking-widest">SMARTLYWEAR</h2>
                            ...
                            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                                ...
                                <div className="flex ml-6 items-center">
                                    ...
                                    <div className="relative">
                                        <select value={size} onChange={(e) => { refreshVariant(e.target.value, color) }} className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-violet-500 text-base pl-3 pr-10">
                            ...
                            <div className="flex">
                                ...
                                <button onClick={() => { buyNow(slug, 1, product.price, product.title, size, color) }} className="flex ml-8 text-white bg-violet-600 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-violet-800 rounded">Buy Now</button>
                                <button onClick={() => { addToCart(slug, 1, product.price, product.title, size, color) }} className="flex ml-4 text-white bg-violet-600 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-violet-800 rounded">Add to Cart</button>
                            ...
                            <div className='pin mt-6 flex space-x-2 text-sm'>
                                <input onChange={onChangePin} type='text' placeholder='Enter Your pincode' className='px-2 border-2 border-gray-500' />
                                <button onClick={checkServiceability} className=' text-white bg-violet-500 border-0 py-2 px-6 focus:outline-none hover:bg-violet-600 rounded'>Check</button>
                            </div>
